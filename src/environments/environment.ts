export const environment = {
  ...
  backend: {
    ...
    getMetricQueryDetails: 'https://api.tracified.com/api/v2/public/metric-query'
  },
  ...
  blockchain: {
    ...
    getPocTreeDataWithMerkletree: 'https://gateway.tracified.com/pocv4/merkletree/',
